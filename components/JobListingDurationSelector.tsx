...
import { JobListingDurationPrice } from "@/app/utils/JobListingDurationPrice";
...
const JobListingDurationSelector = ({ field }: DurationProps) => {
  return (
    <RadioGroup
    ...
    >
      <div className="flex flex-col gap-4">
        {JobListingDurationPrice.map((duration) => (
